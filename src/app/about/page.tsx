...
import { useLightbox, LightboxTrigger } from "@/components/Lightbox";
            ...
            <nav className="fixed top-0 left-0 right-0 z-[100] px-6 md:px-12 py-8 pointer-events-none">
                <div className="max-w-7xl mx-auto flex justify-between items-center">
                    <Link href="/" className="pointer-events-auto w-12 h-12 rounded-full glass-card flex items-center justify-center hover:scale-105 transition-all duration-300 group">
                        <ArrowLeft size={20} className="text-brand-gold group-hover:text-white transition-colors duration-300" />
                    </Link>
            ...
            <section className="max-w-7xl mx-auto px-6 md:px-12 grid md:grid-cols-2 gap-20 items-center mb-32">
                ...
                >
                    <div
                        ...
                        onClick={() => openLightbox("https://images.unsplash.com/photo-1542038784456-1ea8e935640e?w=1000&q=80&auto=format", "Studio Philosophy", "The Ethos")}
                    >
                        <Image
                            ...
                            width={800}
                            height={1000}
                            className="rounded-3xl object-cover shadow-[0_32px_100px_rgba(0,0,0,0.35)] border border-white/5 transition-transform duration-700 group-hover:scale-[1.02]"
                            sizes="(max-width: 768px) 100vw, 50vw"
                        />
                        {/* Lightbox Trigger */}
                        <div className="absolute bottom-6 right-6 opacity-0 group-hover:opacity-100 transition-opacity duration-500 delay-100 z-20">
                            <LightboxTrigger src="https://images.unsplash.com/photo-1542038784456-1ea8e935640e?w=1000&q=80&auto=format" title="Studio Philosophy" category="The Ethos" />
                        </div>
                    </div>
                </motion.div>

                <div className="space-y-8">
                    <PremiumCard title="The Process" className="shadow-[0_24px_60px_rgba(0,0,0,0.3)]">
                        <p>Our approach is rooted in the principles of African Modernism—structure, warmth, and geometry. We strip away the unnecessary to reveal the essential truth of the subject.</p>
                    </PremiumCard>

                    <PremiumCard title="The Promise" className="shadow-[0_24px_60px_rgba(0,0,0,0.3)]">
                        <p>To deliver not just photographs, but artifacts. Physical and digital tokens of memory that will outlast the moment they were captured.</p>
                    </PremiumCard>
                </div>
            </section>
